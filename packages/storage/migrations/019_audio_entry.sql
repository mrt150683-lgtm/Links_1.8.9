-- Migration 019: Add audio entry type
-- Adds 'audio' to the entries.type CHECK constraint
-- Pattern: rebuild table (SQLite cannot ALTER CHECK constraints)

PRAGMA foreign_keys = OFF;

-- Create new entries table with audio type added
CREATE TABLE entries_new (
  id TEXT PRIMARY KEY NOT NULL,
  pot_id TEXT NOT NULL,
  type TEXT NOT NULL CHECK(type IN ('text', 'image', 'doc', 'link', 'audio')),
  content_text TEXT,
  content_sha256 TEXT,
